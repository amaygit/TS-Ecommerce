      ...
      <div className="relative grid gap-8 p-8 md:grid-cols-2 md:items-center md:p-12 lg:p-14">
        <div className="text-left">
          ...
          <p className="mt-4 max-w-lg text-base leading-relaxed text-base-content/70">
            Construction tools, power equipment, and job-site
            essentials—selected for professionals and DIY projects alike. Secure
            checkout; after purchase, access your order page for support,
            guidance, and assistance whenever needed.
          </p>
